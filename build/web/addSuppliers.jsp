...
<html>
    ...
    <body>
        ...
        %>
        <div class="Container">
        <h1 style="margin-bottom:30px">Add Supplier</h1>
        <div class="center">
            <a href = suppliers.jsp class="bttn"style="margin-bottom:30px;" >Previous Page</a>
        </div>
        ...
        <form method="post" action="AddSupplierServlet">
            <table class="center">
                ...
                <tr><td></td><td><input class="ebttn" type="submit" value="add"></td></tr>
            </table>                   
        </form>
                </div>
    </body>
